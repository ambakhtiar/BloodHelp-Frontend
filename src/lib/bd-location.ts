// Bangladesh location data — all 8 divisions with their districts and upazilas
// This avoids dependency on @bangladeshi/bangladesh-address which has install issues
...
export const BD_DATA: LocationData = {
  ...
  Chattogram: {
    ...
    Comilla: ["Barura", "Brahmanpara", "Burichang", "Chandina", "Chauddagram", "Comilla Adarsha Sadar", "Comilla Sadar Dakshin", "Daudkandi", "Debidwar", "Homna", "Laksam", "Meghna", "Monoharganj", "Muradnagar", "Nangalkot", "Titas"],
